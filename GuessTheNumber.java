    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            for (int i = 1; i <= maxAttempts; i++) {
                input = JOptionPane.showInputDialog(null, "Guess the number between 1 and " + maxNumber + ".\nAttempts remaining: " + (maxAttempts - i + 1) + "\nScore: " + score + "\nTotal score: " + totalScore);
            ...
            if (!correctGuess) {
                JOptionPane.showMessageDialog(null, "Sorry, you did not guess the number.\nThe number was " + randomNumber + ".");
            }
            ...
            if (input.equalsIgnoreCase("yes")) {
                ...
                JOptionPane.showMessageDialog(null, "Thank you for playing!\nYour total score is " + totalScore + " in " + numberOfRounds + " rounds.");
                break;
            }
        } while (true);
    }
